# Generated by Powerlevel10k configuration wizard on 2021-04-20 at 09:45 CEST.
...
function dynamicOsIcon () {
  ...
  function my_git_formatter() {
    ...
    local       meta='%12F' # white foreground
    local      clean='%12F' # black foreground '%0F'
    local   modified='%12F' # black foreground '%0F'
    local  untracked='%12F' # black foreground '%0F'
    local conflicted='%12F' # red foreground
